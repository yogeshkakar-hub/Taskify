      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            >
              <UserPlus size={48} color="#00ffcc" style={{ margin: '0 auto', marginBottom: '1rem', filter: 'drop-shadow(0 0 10px rgba(0,255,204,0.5))' }} />
            </motion.div>
            <h2 style={{ color: '#fff', fontSize: '2rem', margin: 0, fontWeight: 700, letterSpacing: '1px' }}>Create Account</h2>
            <p style={{ color: 'rgba(255, 255, 255, 0.6)', marginTop: '0.5rem' }}>Join Taskify today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {/* Name Field */}
            <div>
              <label style={{ display: 'block', color: '#fff', marginBottom: '0.5rem', fontSize: '0.9rem' }}>Full Name</label>
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    ...
                    border: `1px solid ${getValidationColor('name', isNameValid, name)}`,
                    borderRadius: '12px',
                    color: '#fff',
                    outline: 'none',
                    transition: 'all 0.3s ease',
                    boxShadow: focusedField === 'name' ? `0 0 15px ${getValidationColor('name', isNameValid, name)}40` : 'none',
                    boxSizing: 'border-box'
                  }}
                />
                {name && (
                  <div style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)' }}>
                    {isNameValid ? <CheckCircle2 size={18} color="#00ffcc" /> : <AlertCircle size={18} color="#ff4d4d" />}
                  </div>
                )}
              </div>
            </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
            <p style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem' }}>
              ...
              <Link to="/login" style={{ color: '#00ffcc', textDecoration: 'none', fontWeight: 600 }}>
                Sign In
              </Link>
            </p>
          </div>
